...
import { cn, getDateAdjustedForTimezone } from "@/lib/utils";
...
export const DateRangePicker: FC<DateRangePickerProps> & {
  ...
  const createdAt = new Date("2024-07-12T00:58:14.000Z");
        ...
        <div className="flex justify-end gap-2 py-2 pr-4">
          ...
          <Button
            onClick={() => {
              ...
              if (range.from > createdAt) {
              }
              if (range.to && range.to > createdAt) {
              }
              setIsOpen(false);
